...
<div class="row-fluid">
      ...
      <div class="main_box">
          ...
          <tr>
              ...
              <td><a href="javascript:" onclick="active_store(<?=@$store['id']?>,'<?=@$store['i_is_active']?>')">
			  <?php if($store['i_is_active']=='1'){echo "Active";}else{echo "InActive";}?></a></td>
              <td>
                 <span class="social_btns"> <a target="_blank" href="<?php echo base_url();?>store/viewstore/<?=@$store['id']?>"><img src="<?php echo base_url();?>css/admin/img/view.jpg"></a></span>
                  <!--<span class="social_btns"> <a href="<?php //echo base_url();?>admin/editadd/<?php //@$store['id']?>"><img src="<?php echo base_url();?>css/admin/img/edit.jpg"></a></span>
...
function active_store(id,status){
					...
					$.post("<?php echo base_url();?>admin/activestore" , { id : id, status : status} ,
					function(data){
